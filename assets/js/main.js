...
function kolonaSlika(img){
  return `<div class="col-lg-4 col-sm-12 pl-0 pr-0 d-flex justify-content-center position-relative">
  <img src="${img.slika.src}" alt="${img.slika.alt}" class="img-fluid">
  <h1 class="position-absolute centered text-dark text-center">${img.naziv}</h1>
...
function ispisNovogProizvoda(product){
  return `<div class="mix col-lg-3 col-md-6">
